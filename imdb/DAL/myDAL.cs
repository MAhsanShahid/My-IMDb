...
namespace imdb.DAL
{
    public class myDAL
    {
       ...
       public string getLogin()
        ...
        //    try
        //    {
        //        cmd = new SqlCommand("Select * from imdb.Oscar_Movies", con);  //instantiate SQL command 
        //        cmd.CommandType = CommandType.Text; //set type of sqL Command
        //        using (SqlDataAdapter da = new SqlDataAdapter(cmd))
        //        {
        //            da.Fill(ds); //Add the result  set  returned from SQLCommand to ds
        ...
        //    try
        //    {
        //        cmd = new SqlCommand("Select * from dbo.in_theater", con);  //instantiate SQL command 
        //        cmd.CommandType = CommandType.Text; //set type of sqL Command
        //        using (SqlDataAdapter da = new SqlDataAdapter(cmd))
        //        {
        //            da.Fill(ds); //Add the result  set  returned from SQLCommand to ds
        ...
        //    try
        //    {
        //        cmd = new SqlCommand("Select * from imdb.Upcoming_Movies", con);  //instantiate SQL command 
        //        cmd.CommandType = CommandType.Text; //set type of sqL Command
        //        using (SqlDataAdapter da = new SqlDataAdapter(cmd))
        //        {
        //            da.Fill(ds); //Add the result  set  returned from SQLCommand to ds
        ...
        //    try
        //    {
        //        cmd = new SqlCommand("Select * from dbo.top10", con);  //instantiate SQL command 
        //        cmd.CommandType = CommandType.Text; //set type of sqL Command
        //        using (SqlDataAdapter da = new SqlDataAdapter(cmd))
        //        {
        //            da.Fill(ds); //Add the result  set  returned from SQLCommand to ds
        ...
        public int user_login(string username, string password)
        {
            ...
            try
            {
                SqlCommand cmdselect = new SqlCommand("loginn", con);
        ...
        public int SearchLogin(String user, String pass)
        {
            ...
            try
            {
                cmd = new SqlCommand("loginn", con); //name of your procedure
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet ExecQry(string qry) //to get the values of all the items from table Items and return the Dataset
        {
            DataSet ds = new DataSet(); //declare and instantiate new dataset
            SqlConnection con = new SqlConnection(connString); //declare and instantiate new SQL connection
            con.Open(); // open sql Connection
            ...
            try
            {
                cmd = new SqlCommand(qry, con);  //instantiate SQL command 
                cmd.CommandType = CommandType.Text; //set type of sqL Command
                using (SqlDataAdapter da = new SqlDataAdapter(cmd))
                {
                    da.Fill(ds); //Add the result  set  returned from SQLCommand to ds
        ...
        ////////////////////////////////////////////dawn of planet opf apes
        public DataSet getDawnofPlanetofApes() //to get the values of all the items from table Items and return the Dataset
        {
            DataSet ds = new DataSet(); //declare and instantiate new dataset
            SqlConnection con = new SqlConnection(connString); //declare and instantiate new SQL connection
            con.Open(); // open sql Connection
        ...
        public DataSet getDawnofPlanetofApesdata() //to get the values of all the items from table Items and return the Dataset
        {
            DataSet ds = new DataSet(); //declare and instantiate new dataset
            SqlConnection con = new SqlConnection(connString); //declare and instantiate new SQL connection
            con.Open(); // open sql Connection
        ...
        public DataSet getEdgeofTomorrow() //to get the values of all the items from table Items and return the Dataset
        {
            ...
            try
            {
                cmd = new SqlCommand("SELECT TitleName,RunningTime,Description,ReleaseDate,Rating,Director.FirstName As Dir_F_Name,Director.LastName As Dir_L_Name,Language,Genre.GenreName FROM (imdb.film join imdb.Director on Film.Director_ID=Director.Director_ID) join imdb.Genre on Film.Genre_ID=Genre.Genre_ID where Film.TitleName='Edge of Tomorrow'", con);  //instantiate SQL command 
                cmd.CommandType = CommandType.Text; //set type of sqL Command
                using (SqlDataAdapter da = new SqlDataAdapter(cmd))
                {
                    da.Fill(ds); //Add the result  set  returned from SQLCommand to ds
        ...
        public DataSet getEdgeofTomorrowdata() //to get the values of all the items from table Items and return the Dataset
        {
            ...
            try
            {
                cmd = new SqlCommand("select imdb.Actor.FirstName,imdb.Actor.LastName,role from imdb.Actor join imdb.ActedIn on imdb.ActedIn.Actor_ID=imdb.Actor.Actor_ID join imdb.Film on imdb.ActedIn.Film_ID=imdb.Film.Film_ID where TitleName='Edge of Tomorrow' ", con);  //instantiate SQL command 
                cmd.CommandType = CommandType.Text; //set type of sqL Command
                using (SqlDataAdapter da = new SqlDataAdapter(cmd))
                {
                    da.Fill(ds); //Add the result  set  returned from SQLCommand to ds
